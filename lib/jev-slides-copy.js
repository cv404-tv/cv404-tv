  ...
  zh: {
    ...
    slides: [
      ...
      },
      {
        ...
        diagramAlt: '上下文和问题进入 Jev，分成 Choice 路径选择、Score 单维打分、Noul 命题概率三类判断',
        inputHint: '上下文 + 问题', coreLabel: '结构化判断',
        artOutputs: ['选路径', '量程度', '命题概率'],
  ...
  en: {
    ...
    slides: [
      ...
      },
      {
        ...
        diagramAlt: 'Context and question enter Jev and branch into Choice, Score, and Noul judgments',
        inputHint: 'Context + question', coreLabel: 'Structured judgment',
        artOutputs: ['Select', 'Rate', 'P(true)'],
