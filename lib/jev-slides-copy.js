export const jevSlidesCopy = {
  zh: {
    ...
    navigationHint: '方向键 / 空格翻页', page: '页', posterDetails: '海报信息',
    slides: [
      {
      ...
      {
        kind: 'partners', eyebrow: '01 / 活动伙伴', title: '主办与活动伙伴',
        organizerLabel: '主办方', organizer: '云谷404', coorganizerLabel: '活动伙伴',
        coorganizers: ['杭州AI工坊', '杭州黑客与画家', 'YOUR SPACE'],
        foot: '伙伴标识以最新活动海报为准。',
      },
      {
      ...
      {
        kind: 'model', eyebrow: '04 / 认识 Jev', title: '给软件一个判断力。',
      ...
      {
        kind: 'showcase', eyebrow: '09 / 演示与评审建议', title: '让别人看见\n你的判断。',
  ...
  en: {
    ...
    navigationHint: 'Arrow keys / Space to advance', page: 'Slide', posterDetails: 'Poster details',
    slides: [
      {
      ...
      {
        kind: 'partners', eyebrow: '01 / EVENT PARTNERS', title: 'Organizer and event partners',
        organizerLabel: 'ORGANIZER', organizer: 'CLOUD VALLEY 404', coorganizerLabel: 'EVENT PARTNERS',
        coorganizers: ['AI Builder Lab', 'Hangzhou Hackers and Painters', 'YOUR SPACE'],
        foot: 'Partner marks follow the latest event poster.',
      },
      {
      ...
      {
        kind: 'model', eyebrow: '04 / MEET JEV', title: 'Give software judgment.',
      ...
      {
        kind: 'example', eyebrow: '05 / A SMALL EXAMPLE', title: 'From ticket to action.',
      ...
      {
        kind: 'tracks', eyebrow: '06 / CHOOSE A DIRECTION', title: 'Start with a small problem.',
      ...
      {
        kind: 'deliver', eyebrow: '07 / SUGGESTED DELIVERABLE', title: 'Show the full\ndecision path.',
      ...
      {
        kind: 'timeline', eyebrow: '08 / EVENT SCHEDULE', title: 'One day to build.',
      ...
      {
        kind: 'showcase', eyebrow: '09 / PROPOSED SHOWCASE & SCORING', title: 'Make your judgment\nvisible.',
