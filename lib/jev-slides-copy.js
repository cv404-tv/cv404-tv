export const jevSlidesCopy = {
  zh: {
    ...
    slides: [
      ...
      {
        kind: 'partners', eyebrow: '01 / 活动伙伴', title: '主办与协办',
        organizerLabel: '主办方', organizer: '云谷404', coorganizerLabel: '协办方',
      ...
      },
      {
        ...
        detail: '09.27  ·  10:00–20:00', secondary: '云谷中心 B2-3F 活动区  ·  海报标注免费报名 / 限 30 名',
  ...
  en: {
    ...
    slides: [
      ...
      {
        kind: 'partners', eyebrow: '01 / EVENT PARTNERS', title: 'Hosts and co-hosts',
        organizerLabel: 'ORGANIZER', organizer: 'CLOUD VALLEY 404', coorganizerLabel: 'CO-HOSTS',
      ...
      },
      {
        ...
        detail: 'SEP 27  ·  10:00–20:00', secondary: 'Cloud Valley Center · B2-3F event area · Poster says free / 30 places',
