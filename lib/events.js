...
export const eventCatalog = [
  {
    ...
    zh: {
      ...
      category: "JEV / 黑客松",
      title: "让 AI 做出下一步决定",
      description: "用 Jev 串起输入、判断与动作，做出能演示的作品。报名意向已开放，具体环节持续更新。",
    ...
    en: {
      ...
      description: "Build a working input → judgment → action flow with Jev. Applications are open; session details will follow.",
