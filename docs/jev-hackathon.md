...
活动时间为 2026-09-27 10:00–20:00，地点为云谷中心 B2-3F 活动区。人数、费用、组队规则、奖项、API 额度与合作方仍待确认。当前页面征集报名意向，环节顺序、演示时长、评审和作品要求均标为拟定或建议；正式规则确认后同步更新 `lib/hackathon-copy.js` 的中英文内容。
