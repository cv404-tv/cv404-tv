...
活动时间为 2026-09-27 10:00–20:00，地点为云谷中心 B2-3F 活动区；免费报名、限 30 名。最新海报列出云谷404、杭州AI工坊、杭州黑客与画家和 YOUR SPACE。比赛提供价值 $300 的国际顶尖模型 Token；具体模型、领取方式与使用规则仍待主办方通知。大奖为 Ulanzi Vibe Key。主办方已确认当天五个流程时段，见[活动流程](./jev-hackathon-plan.md)。其余奖项与伙伴分工仍待确认；演示时长、评审和作品要求仍为建议。
