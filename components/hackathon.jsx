  ...
  return <div className="jev-site"><a className="skip-link" href="#jev-main">{locale === 'zh' ? '跳转到内容' : 'Skip to content'}</a><Header />
    <main id="jev-main" className="jev-page">
      ...
      <section className="jev-hero">
        <div className="jev-hero-copy"><span className="jev-badge"><i />{t.badge}</span><h1>{t.title[0]}<br /><em>{t.title[1]}</em></h1><p>{t.intro}</p><div className="jev-actions"><a className="jev-button" href="#apply">{t.apply}<span>↗</span></a><a className="jev-text-link" href="#about">{t.learn} ↓</a></div></div>
